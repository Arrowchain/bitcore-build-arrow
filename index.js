...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-arrow/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-arrow -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-arrow -o bitcore-lib-arrow.js';
    }
